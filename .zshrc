...
########### Autoload Functions and Completion Settings #############
...
# Configure prompt appearance and functionality
configure_prompt() {
    prompt_symbol=㉿
...
########### Telemetry Configuration for Dotnet CLI #############
...
########### Precmd Configuration #############
precmd() {
    # Print the previously configured title
    print -Pnr -- "$TERM_TITLE"

    # Print a new line before the prompt, if enabled
